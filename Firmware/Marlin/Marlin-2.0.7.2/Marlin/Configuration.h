...
#define STRING_CONFIG_H_AUTHOR "(@ASrubioCW, Voron 1 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "VORON 1.8"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 608 }
